...
<div class="contentset">
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-6 product-description ">
                ...
                <div class="mb-3">
                    ...
                    <br/><br/>
                    <button class="btn btn-secondary" type="button" onclick="loadReviewList(1)">사진리뷰보기</button>
                    <button class="btn btn-secondary" type="button" onclick="loadCommentList(1)">한줄리뷰보기</button>
                    <button class="btn btn-info"
                            onclick="location.href='/seller/myProduct?sellerIdx=${product.sellerIdx}'">목록보기
                    </button>
                </div>
            </div>
        </div>
        ...
        <div>
            <button id="scrollTopBtn" class="btn btn-primary" onclick="scrollToTop()"><i class="fas fa-arrow-up"></i>
            </button>
        </div>
