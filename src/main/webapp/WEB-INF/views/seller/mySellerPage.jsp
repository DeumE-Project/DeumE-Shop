                            ...
                            <div class="row no-gutters align-items-center">
                                <div class="col mr-2">
                                    <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
                                        누적 매출</div>
                                    <div class="h5 mb-0 font-weight-bold text-gray-800"><fmt:formatNumber value="${myRev}" pattern="#,###"/>원</div>
                                </div>
                                <div class="col-auto">
                        ...
                        <div class="card-body">
                            <div class="row no-gutters align-items-center">
                                <div class="col mr-2">
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col-auto">
                                            <div class="h5 mb-0 mr-3 font-weight-bold text-gray-800"><fmt:formatNumber value="${dateRev}" pattern="#,###"/>원</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="card-body">
                            <div class="row no-gutters align-items-center">
                                <div class="col mr-2">
                                    ...
                                    <div class="h5 mb-0 font-weight-bold text-gray-800"><fmt:formatNumber value="${avgRev}" pattern="#,###"/>원</div>
                                </div>
                                <div class="col-auto">
                                    <i class="fas fa-calendar fa-2x text-gray-300"></i>
                                </div>
                            ...
                            <table class="table table-bordered">
                                ...
                                <c:forEach items="${bestSellRevList}" var="revProduct" varStatus="loop">
                                    <tr>
                                        ...
                                        <td><fmt:formatNumber value="${revProduct.sellRev}" pattern="#,###"/>원</td>
                                    </tr>
                                </c:forEach>
                            </table>
                        </div>
